...
Provides a reverb DSP stage with pre-delay, diffusion body, and high-frequency damping control. Positioned after the tape delay stage in the signal chain. The reverb wet/dry blend, tail decay, pre-delay, and damping are exposed as MIDI-learnable knobs in the Effects panel.
