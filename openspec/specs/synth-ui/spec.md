...
Defines the overall layout, visual aesthetic, and panel-level controls for the subtractive synthesizer user interface. The UI is organized into five labeled control panels arranged horizontally above a full-width keyboard, applying a consistent Moog-inspired dark theme throughout.
