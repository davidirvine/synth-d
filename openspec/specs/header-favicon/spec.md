# header-favicon Specification

## Purpose

Render the SYNTH-D favicon glyph as a decorative, glowing purple brand mark centered in the app header, without altering the browser tab icon or displacing existing header content.
