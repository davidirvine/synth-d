...
- [ ] 3.1 Create a `feature/drop-develop-branch` worktree from main (per the existing CLAUDE.md rules — this branch will become the base for itself once merged)
...
- [ ] 4.5 Verify `README.md` and `CLAUDE.md` are consistent with each other after edits
