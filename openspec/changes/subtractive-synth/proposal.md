...
- 2-octave interactive keyboard with QWERTY mapping and legato behavior
...
- `keyboard`: 2-octave visual piano with QWERTY mapping, legato on new key press, maps to frequency and gate parameters
