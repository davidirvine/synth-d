...
var root$18 = /* @__PURE__ */ from_html(`<div class="keyboard-wrap svelte-1dlz8xf"><svg><rect fill="#333"></rect><!><!><!><!></svg></div>`);
...
var root_2$1 = /* @__PURE__ */ from_html(`<div class="popover svelte-skeerl" role="dialog" aria-label="Patches"><!> <div class="save-row svelte-skeerl"><input class="name-input svelte-skeerl" type="text" placeholder="patch name" aria-label="patch name"/> <!></div> <!></div>`);
...
var root$10 = /* @__PURE__ */ from_html(`<div class="panel svelte-1pr5o9o"><span class="panel-label svelte-1pr5o9o">OSCILLOSCOPE</span> <div class="scope-body svelte-1pr5o9o"><canvas style="display: block; width: 100%; height: 80px; background: #1c1c1c;"></canvas></div></div>`);
