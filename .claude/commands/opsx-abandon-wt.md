...
1. Confirm with the user what exactly they want to abandon:
   - Just the worktree + branch (implementation attempt), keeping the proposal on develop?
...
3. If the user also wants to drop the proposal from develop, do that separately:
