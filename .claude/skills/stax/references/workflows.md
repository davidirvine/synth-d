...
1. `stax agent create "agent-1" --base main` — create agent worktree with stacked branch
...
1. `stax branch reparent -b target-branch -p new-parent` — change a branch's parent
